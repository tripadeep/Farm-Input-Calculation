...
<div class="modal fade" id="insert" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Soil Data Insertion</h4>
        </div>
        <div class="modal-body">
          <%@ include file="Soil_ins.jsp" %>
        </div> 
      </div>
    </div>
  </div>
  ...
  <div class="modal fade" id="update" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Soil Data Updation</h4>
        </div>
        <div class="modal-body">
          <%@ include file="Soil_up.jsp" %> 
        </div> 
      </div>
    </div>
  </div>
  ...
  <div class="modal fade" id="delete" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Soil Data Deletion</h4>
        </div>
        <div class="modal-body">
        <%@ include file="Soil_del.jsp" %>
        </div> 
      </div>
    </div>
  </div>
  ...
  <div class="modal fade" id="show" role="dialog">
    ...
    <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Soil Data </h4>
        </div>
        <div class="modal-body">
       <%@ include file="Soil_sho.jsp" %>
        </div> 
      </div>
    </div>
  </div>
